...
def save_users_to_file(not_following_back, not_followed_back, filename='non_reciprocal_users.txt'):
...
def main():
    ...
    print(f'Successfully saved non-reciprocal users to non_reciprocal_users.txt')
